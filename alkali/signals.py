...
field_update = signal('filed_update', doc = 'called when a model field is set')
...
post_store  = signal('pre_store'  , doc = 'called after all Model objects are stored to disk')
